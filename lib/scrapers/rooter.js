...
(function() {
  ...
  exports.RooterScraper = RooterScraper = (function(_super) {
    ...
    RooterScraper.prototype.hunt2 = function(_arg, cb) {
      var err, json, name, out, proof_text_check, rc, toot, turl, url, username, ___iced_passed_deferral, __iced_deferrals, __iced_k;
    ...
    RooterScraper.prototype.check_status = function(_arg, cb) {
      ...
      (function(_this) {
        ...
        return function() {
          var _ref1, _ref2;
          console.log("w---w--w---w---w-");
          console.log(json);
          rc = rc !== v_codes.OK ? rc : (typeof json !== "undefined" && json !== null ? (_ref1 = json.toot) != null ? (_ref2 = _ref1.post) != null ? _ref2.indexOf(proof_text_check) : void 0 : void 0 : void 0) >= 0 ? v_codes.OK : v_codes.NOT_FOUND;
          return cb(err, rc);
        };
      })(this));
    };
